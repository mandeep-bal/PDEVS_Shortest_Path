...
private:
    enum State {IDLE, PREP_MOVE_FWD, MOVE_FWD, MX_STOP, WAIT_DATA, PREP_TURN, TURN_ALPHA, PREP_STOP, PREP_TURN2, MX_STOP2};
...
public:
    ...
    std::vector<MSG> out() const noexcept {
    	...
    	else if(_state== MX_STOP || _state== MX_STOP2 || _state==TURN_ALPHA || _state== PREP_STOP)
    	{
